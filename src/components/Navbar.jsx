...
<Link to="/bmi">
  <button className="text-black font-bold hover:text-pink-600 px-2 py-2 text-sm">BMI</button>
</Link>
<Link to="/journal">
  <button className="text-black font-bold hover:text-pink-600 px-2 py-2 text-sm">Journal</button>
</Link>
